...
struct ipp_hdr {
	int8_t  major_version; /* всегда 1 */
	int8_t  minor_version; /* всегда 1 */
	union {
		int16_t op;        /* идентификатор операции */
		int16_t st;        /* статус */
	} u;
	int32_t request_id;    /* идентификатор запроса */
	char    attr_group[1]; /* начало группы опциональных запросов */
};
